...
(function() {
	...
	const css = `
		...
		header[role="banner"] button, header[role="banner"] button:hover, header[role="banner"] button:active, header[role="banner"] button:focus, header[role="banner"] button:visited, header[role="banner"] button:disabled, header[role="banner"] button[disabled] {
			color: #344563 !important;
			background-color: transparent !important;
		}
		header[role="banner"] button:hover, header[role="banner"] button:hover:hover, header[role="banner"] button:active:hover, header[role="banner"] button:focus:hover, header[role="banner"] button:visited:hover, header[role="banner"] button:disabled:hover, header[role="banner"] button[disabled]:hover {
		   background-color: rgba(222,235,255,0.9) !important;
		   color:#0052CC !important;
		}
		header[role="banner"] button:focus, header[role="banner"] button:hover:focus, header[role="banner"] button:active:focus, header[role="banner"] button:focus:focus, header[role="banner"] button:visited:focus, header[role="banner"] button:disabled:focus, header[role="banner"] button[disabled]:focus {
			color: #000 !important;
			box-shadow: 0 0 0 2px #2684FF !important;
		}
		header[role="banner"] button[aria-expanded="true"] {
		...
		header[role="banner"] [role="img"] {
		    --icon-secondary-color: #FFFFFF !important;
		}
		header[role="banner"] span[default=""] {
		  color: #6B778C !important;
		}
		header[role="banner"] > nav > div:last-of-type::after {
		    background: linear-gradient(90deg,rgba(255,255,255,0) 0%,rgba(255,255,255,0.7) 50%,rgba(255,255,255,1) 100%) !important;
		}
		header[role="banner"] input:not([type="checkbox"]):not([type="radio"]) {
		    background-color: #FFFFFF !important;
			color: #6B778C !important;
			border-color: #DFE1E6 !important;
			box-shadow: none !important;
		}
		header[role="banner"] input:not([type="checkbox"]):not([type="radio"])[data-test-id="search-dialog-input"].focus-visible {
