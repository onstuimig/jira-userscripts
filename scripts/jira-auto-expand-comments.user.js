// ==UserScript==
// @name         JIRA Auto expand comments
// @description  Automatically expand all comments in the issue view
	...
	const observer = new MutationObserver(function(mutations) {
		for (let i = 0; i < mutations.length; i++) {
			...
			if(mutation.addedNodes.length){
				const more_comments_button = document.querySelector('[data-test-id="issue.activity.comments-list"] + div > button');
